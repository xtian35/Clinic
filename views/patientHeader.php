                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <img class="img-xs rounded-circle" src="<?php if (isset($_SESSION['patientProfilepicture'])) {
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                <img class="col-md-3 rounded-circle" src="<?php if (isset($_SESSION['patientProfilepicture'])) {
                                                                                echo $_SESSION['patientProfilepicture'];
                                                                            } else {
                                                                                echo '../public/assets/images/file-icons/default_profile.png';
                                                                            } ?>" alt="Profile image">
                                <p class="mb-1 mt-3 font-weight-semibold"><?php echo $_SESSION['patientFname'] ?></p>
                                <p class="fw-light text-muted mb-0"><?php echo $_SESSION['patientEmail'] ?></p>
                            </div>
                            <a href="../views/patientUpdateprofile.php" name="updateProfile" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile </span></a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="patientAppointment.php?from=<?php echo date('Y-m-d'); ?>&to=<?php echo date('Y-m-d', strtotime('+7 days')); ?>">
                            <i class="menu-icon mdi mdi-account-circle-outline"></i>
                            <span class="menu-title">Appointments</span>
                        </a>
                    </li>

                    <li class="nav-item nav-category">Doctor's Schedule</li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
                            <i class="menu-icon mdi mdi-calendar-text-outline"></i>
                            <span class="menu-title">Calendar</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="patientsetSchedule.php">Set Schedule</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item nav-category">Others</li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#form-elementss" aria-expanded="false" aria-controls="form-elements">
                        ...
                        <div class="collapse" id="form-elementss">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="patientHistoryFront.php">My History</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
