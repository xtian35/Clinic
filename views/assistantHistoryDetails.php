        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="col-12 d-flex justify-content-between align-items-center mb-2">
                    <h4 class="card-title m-0">History<?php echo isset($_GET['filter']) && $_GET['filter'] == date('Y-m-d') ? " Today" : (isset($_GET['filter']) ? ' on ' . date('M d, Y', strtotime($_GET['filter'])) : ' Today'); ?></h4>
                    <div>
                        <form method="get" action="assistantHistoryDetails.php" id="filter-form">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($row as $result) : ?>
                            <tr>
                                ...
                                <td><?php echo $result['Doctor_Schedule_type'] == 1 ? "Appointment" : "Walk In" ?></td>
                                <td>
                                    <?php if ($result['Appointment_status'] == 4) { ?>
                                        <a class="btn btn-primary btn-sm px-4" href="assistantHistoryTooth.php?appointment_id=<?= $result['Appointment_ID']; ?>&patient_id=<?= $result['Patient_ID']; ?>"><i class="fa fa-eye"></i> View</a>
                                    <?php } else { ?>
